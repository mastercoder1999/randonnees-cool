class Application{
    ...
    actionAjouterRandonnee(randonnee){
        this.RandonneeDAO.ajouter(randonnee);
        this.window.location.hash = "#liste-randonnee";
    }

    actionModifierRandonnee(randonnee){
        this.RandonneeDAO.modifier(randonnee);
        this.window.location.hash = "#liste-randonnee";
    }
}
